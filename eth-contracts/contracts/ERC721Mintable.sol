...
//  5) create a Paused & Unpaused event that emits the address that triggered the event
    event Paused(address trigger_address);
    event Unpaused(address trigger_address);
}
...
contract ERC721 is Pausable, ERC165 {
    ...
    function ownerOf(uint256 tokenId) public view returns (address) {
        ...
        require(_tokenOwner[tokenId] != address(0), "owner must be valid address");
...
//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public {
        ...
        require(to != owner, "address must not be the owner of the tokenId");

        // TODO require the msg sender to be the owner of the contract or isApprovedForAll() to be true
        require( (msg.sender == owner || isApprovedForAll(ownerOf(tokenId), msg.sender)), "msg sender needs to be the owner of the contract or isApprovedForAll() needs to be true");
    ...
    function getApproved(uint256 tokenId) public view returns (address) {
        ...
        require(_approvalExists(tokenId), "Token approval does not exist");
    ...
    function _approvalExists(uint256 tokenId) internal view returns (bool) {
    ...
    function _transferFrom(address from, address to, uint256 tokenId) internal {
        ...
        require(ownerOf(tokenId) == from, "From address must be the owner of the token");
...
contract StoneCapToken is ERC721Metadata("StoneCap Token", "SCAP", "https://s3-us-west-2.amazonaws.com/udacity-blockchain/capstone/") {
